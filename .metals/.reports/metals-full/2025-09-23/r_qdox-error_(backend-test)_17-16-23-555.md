error id: file://<WORKSPACE>/src/test/java/com/ulog/backend/auth/AuthValidationTest.java
file://<WORKSPACE>/src/test/java/com/ulog/backend/auth/AuthValidationTest.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/test/java/com/ulog/backend/auth/AuthValidationTest.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/test/java/com/ulog/backend/auth/AuthValidationTest.java